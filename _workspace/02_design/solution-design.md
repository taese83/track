...
```json web-harness:solution-design
{
  ...
  "moduleBoundaries": [
    ...
    {"scope": "src/pages/track-viewer", "rationale": "6화면 상태 머신. 각 화면 상태의 마운트는 그 상태를 만드는 FEAT가 소유한다 — FEAT-001 input·error, FEAT-006 3d 씬, FEAT-013 3분할 셸과 목록 페인, FEAT-014 WebGL 게이트. FEAT-006은 위젯만 내고 머지돼(PR #21) 셸 배선이 FEAT-013으로 넘어왔다"},
  ...
  "acceptanceRefs": [
    ...
    "FEAT-019",
    "TC-019-1", "TC-019-2", "TC-019-3", "TC-019-4", "TC-019-5", "TC-019-6", "TC-019-7", "TC-019-8",
    "FEAT-020",
    "TC-020-1", "TC-020-2", "TC-020-3", "TC-020-4", "TC-020-5", "TC-020-6", "TC-020-7"
  ],
  "nonGoals": [
